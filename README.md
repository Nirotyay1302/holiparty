...
A complete web application for promoting and managing bookings for Spectra HoliParty – **our 2nd year** of organizing! Event at **Dighi Garden Mankundu** | Schedule: **10:00 AM – 5:00 PM**

## Features

- Event promotion page with Previous Year Photos
- Online booking with **3 pass types**: Entry (₹200), Entry+Starter (₹350), Entry+Starter+Lunch (₹499)
